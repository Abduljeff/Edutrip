    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form enctype="multipart/form-data" method="post" action="{{ url('/owner/add-event') }}" class="form-horizontal" name="add_event" id="add_event" novalidate="novalidate">{{ csrf_field() }}
